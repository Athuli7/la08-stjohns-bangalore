...
(function ($) {
	...
	function initniskarGmap() {
		...
		if ($("#site-google-map").attr("data-map-style")) {
			...
			switch (map_mode) {
				case 'Aubergine': map_style_mode = map_style_obj.Aubergine; break;
				case 'Silver': map_style_mode = map_style_obj.Silver; break;
				case 'Retro': map_style_mode = map_style_obj.Retro; break;
				case 'Dark': map_style_mode = map_style_obj.Dark; break;
				default: map_style_mode = map_style_obj.Night; break;
			}
		}

		var LatLng = {
			lat: parseFloat($("#site-google-map").attr("data-map-lat")),
			lng: parseFloat($("#site-google-map").attr("data-map-lng")),
		};
