				...
				<div class="sticky-head">
					<div class="basic-container clearfix">
						...
						<ul class="nav mobile-header-items pull-center">
							<li>
								<a href="{{ route('home') }}" class="img-before"><img src="images/logo-dark.png" class="img-fluid" width="149" height="45" alt="Logo"></a>
							</li>
						</ul>
							...
							<ul class="nav navbar-items pull-right">
								...
								<li class="list-item">
									<ul class="nav navbar-main menu-dark">
										...
										<li class="active dropdown mega-dropdown dropdown-sub relative"><a href="ministries-grid-2.html">Ministries</a>
											<ul class="dropdown-menu mega-dropdown-menu dropdown-col-2">
												<li class="mega-dropdown-col"><a href="#" class="text-uppercase theme-color">Ministry Details</a>
													...
													<li class="active"><a href="childrens-ministry.html">Childrens Ministry</a></li>
